...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccessGroup.can_be_shared_with'
        db.add_column('access_accessgroup', 'can_be_shared_with', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding M2M table for field can_share_with on 'AccessGroup'
        db.create_table('access_accessgroup_can_share_with', (
        ...
        db.create_unique('access_accessgroup_can_share_with', ['from_accessgroup_id', 'to_accessgroup_id'])

        # Adding unique constraint on 'AccessGroup', fields ['name']
        db.create_unique('access_accessgroup', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AccessGroup', fields ['name']
        db.delete_unique('access_accessgroup', ['name'])
        ...
        # Deleting field 'AccessGroup.can_be_shared_with'
        db.delete_column('access_accessgroup', 'can_be_shared_with')

        # Removing M2M table for field can_share_with on 'AccessGroup'
        db.delete_table('access_accessgroup_can_share_with')
    ...
    models = {
        'access.accessgroup': {
            ...
            'can_share_with': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'can_share_with_rel_+'", 'blank': 'True', 'to': "orm['access.AccessGroup']"}),
