...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('access_accessgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('supergroup', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('access', ['AccessGroup'])

        # Adding M2M table for field members on 'AccessGroup'
        db.create_table('access_accessgroup_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accessgroup', models.ForeignKey(orm['access.accessgroup'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('access_accessgroup_members', ['accessgroup_id', 'user_id'])

        # Adding model 'Invitation'
        db.create_table('access_invitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lp_username', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['access.AccessGroup'])),
        ))
        db.send_create_signal('access', ['Invitation'])


    def backwards(self, orm):
        
        # Deleting model 'AccessGroup'
        db.delete_table('access_accessgroup')

        # Removing M2M table for field members on 'AccessGroup'
        db.delete_table('access_accessgroup_members')

        # Deleting model 'Invitation'
        db.delete_table('access_invitation')
